package de.varylab.jrworkspace.plugin.sidecontainer.image;
...
public class ImageHook { 
	 ...
	 * @param image
	 */
	public static void setDialogIconImage(JDialog dialog, Image image) {
		Class<? extends JDialog> dialogClass = dialog.getClass();
		try {
